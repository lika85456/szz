...
\textbf{Součin matic}
%screenshot_2025-05-26_11-12-59.png
\begin{figure}
	\begin{center}
		\includegraphics[width=0.95\textwidth]{img/screenshot_2025-05-26_11-12-59.png}
	\end{center}
\end{figure}


\textbf{Inverzní matice}

\begin{itemize}
	\item matice musí být čtvercová
	\item $ det(A)\neq0 $
\end{itemize}

Metoda Gauss-Jordan:
\begin{itemize}
	\item Sestav rozšířenou matici $[A|E]$, kde $E$ je jednotková matice stejného řádu jako $A$.
	\item Pomocí Gaussovy eliminace převeď matici $[A|E]$ na tvar $[E|B]$, kde $B$ je inverzní matice k $A$.
\end{itemize}
