...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item vybere si náhodný vrchol, postupně přidává další vrcholy podle toho, jaká je v aktuálním řezu grafu (mezi již vybranými vrcholy a ostatními) hrana s nejmenší hodnotou(tj. hrana s nejmenší hodnotou mezi vrcholy už v kostře a vrcholy mimo kostru)
	...
	\begin{itemize}
		...
		\item keříci - vždy přidá nejlevnější hranu, která spojí dva keříky, pokud by byla hrana v rámci jednoho keříku je zahozena.
	\end{itemize}
	\item Dijkstra
	\begin{itemize}
